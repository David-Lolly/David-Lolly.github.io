...
date: 2025-11-30
status: 进行中
image: ./images/ChatView.png
description: TinyAISearch 是一个轻量但强大的 AI 搜索项目，为你完整揭示从智能搜索规划、网页爬取、内容召回到流式问答的 RAG 全链路。 
tags: [Python, LangChain, FastAPI, AI]
github_url: https://github.com/David-Lolly/TinyAISearch
demo_url: https://github.com/David-Lolly/TinyAISearch
stars: 70
forks: 12
---
