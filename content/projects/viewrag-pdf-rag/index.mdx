---
title: ViewRAG - PDF 智能解析与图文并茂问答系统
slug: viewrag-pdf-rag
date: 2026-04-24
status: 已完成
image: ./images/ViewRAG.png
description: 基于 RAG 的 PDF 智能解析系统，支持图片和表格精准召回、引用溯源、图文并茂问答
tags: [RAG, PDF, Vue3, FastAPI, pgvector, LLM]
github_url: https://github.com/David-Lolly/ViewRAG
demo_url: ""
stars: 22
forks: 4
---
...
| :---: | :---: |
| ![Models](./images/models.png) | ![Home](./images/home.png) |

| 引用溯源 (解决信任问题) | PDF高亮溯源 |
| :---: | :---: |
| ![Cite](./images/cite.png) | ![Highlight](./images/highlight.png) |

| PDF 版式识别 | 基于版式的智能分块 |
| :---: | :---: |
| ![Parse](./images/parse.png) | ![Chunk](./images/chunk.png) |

| 深度推理 (Reasoning) | 视觉理解 (Vision Language) |
| :---: | :---: |
| ![Reason](./images/Reason.png) | ![VL](./images/VL.png) |

| 任意节点编辑重生成 | 知识库管理 |
| :---: | :---: |
| ![Edit](./images/edit.png) | ![KB](./images/kb.png) |
