...
export function FeaturedAchievement({ timeline, featuredAchievementId, onOpenImage }: FeaturedAchievementProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#fff8d6]/10 bg-[#242015] p-4 text-[#fff8d6] shadow-[0_20px_70px_rgba(36,32,21,0.25)] sm:rounded-[2rem] sm:p-6 md:p-8 dark:border-transparent dark:bg-[#3a310f] dark:text-[#fff8d6] dark:shadow-[0_22px_70px_rgba(0,0,0,0.46)]">
